    ...
    <header className="sticky top-0 z-50 w-full bg-header-blue shadow-sm">
      <div className="container flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link className="font-medium text-white hover:text-mint-green transition-colors" href="/shop">
            Comprar Cursos
          </Link>
          <Link className="font-medium text-white hover:text-mint-green transition-colors" href="/sandbox/1">
            Sandbox
          </Link>
          <Link className="font-medium text-white hover:text-mint-green transition-colors" href="/suggested-courses">
            Cursos
          </Link>
        </nav>
